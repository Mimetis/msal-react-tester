 ...
 * @example
 *   
  let msalTester: MsalPreactTester;
  beforeEach(() => {
    // new instance of msal tester for each test
    msalTester = new MsalPreactTester();
...
class MsalPreactTester {
  ...
  constructor(public interationType: 'Redirect' | 'Popup' = 'Redirect', testAccountInfo = defaultTestAccountInfo,
    ...
    this.client = MsalPreactTester.GetNewClient(testAccountInfo, testAuthenticationResult)
  }
...
export default MsalPreactTester;